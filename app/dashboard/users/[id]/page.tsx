...
const userData = {
    ...
    accountPlan: "Global Collaborator",
    expirationDate: "10-02-2027",
    phone: "+234901451482",
    role: "Donor",
    dateJoined: "10-02-2026",
    lastActive: "Feb 17, 2026; 08:25",
    status: "Active",
    emailVerified: true,
    kycVerified: true,
    lastPasswordChange: "17 Sep, 2025; 08:25"
}
        ...
        <DashboardLayout>
            <div className="space-y-6 max-w-[1400px] mx-auto pb-10">
                ...
                <div className="flex items-center gap-2 text-sm">
                    <Link href="/dashboard/users" className="text-[#667085] hover:text-primary transition-colors">
                        Back
                    </Link>
                    <ChevronRight className="h-4 w-4 text-[#D0D5DD]" />
                    <span className="font-semibold text-[#101828]">User Details</span>
                </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-3xl border border-[#EAECF0] shadow-sm p-8 text-center flex flex-col items-center gap-4">
                            <Avatar className="h-24 w-24 ring-4 ring-gray-50 ring-offset-0">
                                ...
                                <AvatarFallback className="bg-primary/5 text-primary text-2xl font-bold">JB</AvatarFallback>
                            </Avatar>
                            <div className="space-y-1">
                                <h3 className="text-xl font-bold text-[#101828]">{userData.name}</h3>
                                <p className="text-sm text-[#475467]">{userData.email}</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-3xl border border-[#EAECF0] shadow-sm overflow-hidden">
                            ...
                            <div className="p-8 space-y-6">
                                <InfoItem label="Member ID" value={userData.id} />
                                <InfoItem label="Account Plan" value={userData.accountPlan} />
                                <InfoItem label="Expiration Date" value={userData.expirationDate} />
                                <InfoItem label="Phone Number" value={userData.phone} />
                                <InfoItem label="Role" value={userData.role} />
                                <InfoItem label="Date Joined" value={userData.dateJoined} />
                                <InfoItem label="Last Active" value={userData.lastActive} />
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-3xl border border-[#EAECF0] shadow-sm overflow-hidden">
                            <div className="px-8 py-5 border-b border-[#EAECF0]">
                                <h4 className="font-bold text-[#101828]">Profile Status</h4>
                            </div>
                            <div className="p-8 space-y-6">
                                <StatusItem 
                                    label="Status" 
                                ...
                                <StatusItem 
                                    ...
                                    icon={<CheckCircle2 className="h-4 w-4 text-green-500" />}
                                />
                                <InfoItem label="Last Password Change" value={userData.lastPasswordChange} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-3xl border border-[#EAECF0] shadow-sm overflow-hidden min-h-[600px]">
                        <Tabs defaultValue="account" className="w-full h-full flex flex-col">
                            <div className="px-8 pt-6 border-b border-[#EAECF0]">
                                <h4 className="font-bold text-[#101828] mb-6">Activity</h4>
                            ...
                            <TabsContent value="account" className="flex-1 p-8 focus-visible:ring-0">
                                    ...
                                    {accountActivity.map((log, index) => (
                                        <div key={index} className="pl-8 relative group">
                                            ...
                                            <div className="space-y-2">
                                                <p className="text-[#101828] font-medium leading-tight">{log.title}</p>
                                                <div className="space-y-1">
                                                    <p className="text-xs font-semibold text-[#475467]">{log.time}</p>
                                                    <p className="text-xs text-[#667085]">{log.details}</p>
                                                </div>
                                            </div>
                                        </div>
                                    ))}
                            ...
                            <TabsContent value="campaign" className="p-8 flex items-center justify-center text-[#667085] h-64 focus-visible:ring-0">
                                No campaign activity recorded.
                            </TabsContent>

                            <TabsContent value="financial" className="p-8 flex items-center justify-center text-[#667085] h-64 focus-visible:ring-0">
