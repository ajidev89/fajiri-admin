...
import { EventPreviewModal } from "@/components/dashboard/content/event-preview-modal";
    ...
    React.useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                router.push("/content?tab=events");
            } finally {
                setIsLoading(false);
            }
        };
    ...
    const handleUpdate = async () => {
        ...
        try {
            await eventService.updateEvent(eventId, {
                ...
                location,
                start_date: startTime ? `${startDate}T${startTime}` : startDate,
                end_date: endDate ? (endTime ? `${endDate}T${endTime}` : endDate) : undefined,
                status,
                slots,
                amount,
