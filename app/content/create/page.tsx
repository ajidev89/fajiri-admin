...
import { BlogPreviewModal } from "@/components/dashboard/content/blog-preview-modal";
...
export default function CreateBlogPostPage() {
    ...
    const [postDate, setPostDate] = React.useState(() => format(new Date(), "yyyy-MM-dd"));
    const [postTime, setPostTime] = React.useState(() => format(new Date(), "HH:mm"));
    ...
    const addTag = (raw?: string) => {
        const value = (raw ?? tagInput).trim().replace(/,$/, "");
        if (!value) return;
        setTags((prev) =>
    ...
    const handlePublish = async () => {
        ...
        try {
            await blogService.createPost({
                ...
                published_at: postDate && postTime ? `${postDate}T${postTime}` : undefined,
                tags,
            });
            ...
            <div className="space-y-6 max-w-[1400px] mx-auto pb-10">
                    ...
                    <div className="bg-white rounded-3xl border border-[#EAECF0] shadow-sm overflow-hidden">
                        ...
                        <div className="p-8 space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <div
                                    className="min-h-12 p-2 bg-white border border-[#D0D5DD] rounded-xl flex flex-wrap gap-2 items-center cursor-text"
                                ...
                                >
                                    ...
                                    <input
                                        ...
                                        className="flex-1 min-w-[120px] h-8 bg-transparent border-none outline-none text-sm text-[#344054] placeholder:text-[#98A2B3]"
                                    />
                                    <button
                                        type="button"
                                        onClick={(e) => {
                                        ...
                                        className="text-[#667085] hover:text-[#344054] p-0.5 ml-1"
                                        aria-label="Add tag"
                                    >
                ...
                <BlogPreviewModal
                    ...
                    post={{
                        ...
                        image: imagePreview,
                        authorName: name,
                        authorAvatar: mounted ? user?.profile?.avatar : null,
                        publishedAt:
                            postDate && postTime
                                ? `${postDate}T${postTime}`
                                : postDate,
