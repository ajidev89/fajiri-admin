...
const bottomSidebarItems = [
    ...
    { label: "Help & Support", icon: HelpCircle, href: "/dashboard/help-support" },
            ...
            <div className="p-6 border-b border-[#E9EEF2] h-20 flex items-center">
                <div className="flex items-center gap-2">
                    <div className="w-8 h-8 rounded-lg overflow-hidden relative">
                        <div className="w-full h-full bg-primary flex items-center justify-center text-white text-[10px] font-bold">FA</div>
                    </div>
                    <span className="text-xl font-bold text-primary tracking-tight">FAJIRI</span>
                </div>
            </div>
